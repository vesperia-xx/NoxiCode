...
import { addNewEmptyNote, deleteNoteById, savingNewNote, setActiveNote, setNotes, setPhotosToActiveNote, setSaving } from './journalSlice';
...
export const startDeletingNote = () => {
    return async (dispatch, getState) => {
        ...
        dispatch(deleteNoteById(curso.id))
